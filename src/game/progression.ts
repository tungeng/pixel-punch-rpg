...
export const AUGMENTS: Record<string, AugmentDef> = Object.fromEntries([
  ...
  A("junkrat_hairtrigger", "junkrat", "Hair Trigger", "!", "Bad rolls are impossible. Random blasts land above their midpoint.", "burst", {}),
  ...
  A("rein_crusader", "reinhardt", "Crusader Protocol", "♜", "Begin every battle with 9 persistent Armor.", "survival", { block: 0 }),
  A("rein_barrier", "reinhardt", "Barrier Relay", "⬡", "At the start of each turn, Armor projects fresh Block.", "engine", { block: 14 }),
  A("rein_honor", "reinhardt", "Honorbound", "⚒", "Your Armor answers back. Each turn, Retaliate for a third of it.", "burst", {}),
  ...
  A("doom_meteor", "doomfist", "Cataclysm", "◆", "Every second Attack in a fight also quakes ALL enemies for half its damage.", "burst", {}),

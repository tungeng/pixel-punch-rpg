...
export const CARDS: Record<string, CardDef> = {
  ...
  moira_orb_dmg: { id: "moira_orb_dmg", name: "Biotic Orb (Damage)", type: "attack", cost: 1, hero: "moira", rarity: "starter", damage: 3, poison: 5, text: "Deal 3 damage. Apply 5 Poison.", up: { damage: 4, poison: 7 } },
  ...
  moira_grasp: { id: "moira_grasp", name: "Biotic Grasp", type: "attack", cost: 1, hero: "moira", rarity: "starter", damage: 3, damagePerPoison: 1, text: "Deal 3 damage, +1 per Poison on the target.", up: { damage: 4, damagePerPoison: 2 } },
  moira_fade: { id: "moira_fade", name: "Fade", type: "skill", cost: 1, hero: "moira", rarity: "starter", block: 4, blockPerPoisonedEnemy: 4, text: "Gain 4 Block, +4 per poisoned enemy.", up: { block: 6, blockPerPoisonedEnemy: 5 } },
  ...
  moira_leech: { id: "moira_leech", name: "Siphon Life", type: "attack", cost: 1, hero: "moira", rarity: "uncommon", damage: 4, healPerPoisonBoard: 1, text: "Deal 4 damage. Heal 1 per Poison stack on the board.", up: { damage: 6, healPerPoisonBoard: 2 } },

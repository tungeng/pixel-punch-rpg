...
export const HEROES: Record<string, HeroDef> = {
  ...
  mercy: {
    ...
    color: "#fcd34d",
    asset: mercyImg,
    passive: "Regeneration: heal 2 HP at the start of each turn.",
    startingDeck: [
    ...
    ultimate: {
      ...
      strength: 3,
      draw: 3,
      text: "Heal 15 HP. Gain 3 Strength. Draw 3 cards.",
    },
  },
  genji: {
    id: "genji",
  ...
  junkrat: {
    ...
    color: "#eab308",
    asset: junkratImg,
    passive: "Total Mayhem: enemies start each combat with 1 Vulnerable.",
    startingDeck: [

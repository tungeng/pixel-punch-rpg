...
function Settings() {
  ...
  return (
    <MenuShell title="SETTINGS" crumb="Identity, updates and save data">
      ...
      <input
        ...
        style={{ fontFamily: "var(--font-pixel-body)" }}
      />
      <PixelButton onClick={save} color="secondary" className="mt-2 w-full">
      ...
      <div className="border-2 border-destructive/60 bg-destructive/10 p-3">
        <p

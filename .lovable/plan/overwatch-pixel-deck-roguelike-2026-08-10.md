...
> **IP note:** Overwatch is Blizzard's trademark. However permission has been granted to make a fan/parody game  
> using the hero roster and ability *concepts* (names + kit ideas) with  
> original pixel-art designs — not copies of Blizzard's official art. 
